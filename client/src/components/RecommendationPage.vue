<template>
    <main class="grid">
        <div v-show="!showRecommendation" class="main-content overlay">
            <div class="grid">

                <div v-show="!loading" class="container speech-balloon animation-grow">
                ...
                <img v-show="!loading"
                    src="../../public/assets/3d-doodle-of-a-robot-friend-in-orange-and-purple-pallet--2979333082.svg" alt=""
                    class="friend1">


                <div v-show="loading" class="load-wrapp">
                    <div class="load-4">
            ...
            <div v-show="!loading" class="container" id="button-container">
                <button v-on:click="apiCall()" class="button1 animation-grow">RECOMMEND</button>
                <router-link to="/doubleRecomendation" class="rec_for_two animation-rotate">[Try Recommendation for
                    Two]</router-link>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        async apiCall() {
            ...
            try {
                let result = await axios.post("http://localhost:8080/getNewSingleRec", {
                    movie: prompt
                });
                this.loading = false;
                ...
                alert("Sorry, but I'm unable to generate a movie recommendation based on the input " + input.innerText);
                console.error(err);
